...
public class PlayerTabManager : MonoBehaviour
{
    ...
    public PlayerStat playerStat; //플레이어 추가 스텟 정보
    ...
    public void ChangeMonsterInfomation(int PlayerNum)
    {
        ...
        attackDamage.text = "공력력 : " + (playerStats.attackDamageMin+ (playerStat.attackDamageMin * playerStat.attackDamageMinUp)) + " - " + (playerStats.attackDamageMax+ (playerStat.attackDamageMax * playerStat.attackDamageMaxUp)); //공격력
        ...
        {
            health.text = "체력  : " + (hp+ (playerStat.Maxhealth * playerStat.MaxhealthUp)) + " / " + (hp + (playerStat.Maxhealth * playerStat.MaxhealthUp)) + "+(" + ItemStats.Hat[playerStats.Hat] + ")";//체력
        }
        else
        {
            health.text = "체력  : " + (hp + (playerStat.Maxhealth * playerStat.MaxhealthUp)) + " / " + (playerStats.health + (playerStat.Maxhealth * playerStat.MaxhealthUp));//체력
        }
